...
pdf(file.path(outpath,"venn.pdf"), width=12, height=6)
...
legend("topleft", inset=0.05, legend=c("Virgin vs mated (43)", "E vs M (604)"), col =c(cbblue, cborange), pch=c(5,2), cex=.8 ) 
